# Version 5 of the hierarchical model.
...
# save samples
write.table(thetas1,file='thetas1.Rdata',row.names=F,sep=',')
write.table(thetas2,file='thetas2.Rdata',row.names=F,sep=',')
write.table(sj2.lst,file='sj2_lst.Rdata',row.names=F,sep=',')
write.table(mus,file='mus.Rdata',row.names=F,sep=',')
write.table(st2.lst,file='st2_lst.Rdata',row.names=F,sep=',')
